...
public class GHPullRequest extends GHIssue {
   ...
   */
  public PagedIterable<FixedGHPullRequestReviewComment> listReviewComments() throws IOException {
    return new PagedIterable<FixedGHPullRequestReviewComment>() {
      public PagedIterator<FixedGHPullRequestReviewComment> iterator() {
        return new PagedIterator<FixedGHPullRequestReviewComment>(root.retrieve().asIterator(getApiRoute() + "/comments",
          FixedGHPullRequestReviewComment[].class)) {
          protected void wrapUp(FixedGHPullRequestReviewComment[] page) {
            for (FixedGHPullRequestReviewComment c : page)
  ...
  public GHPullRequestReviewComment createReviewComment(String body, String sha, String path, int position) throws IOException {
    return new Requester(root).method("POST")
      ...
      .to(getApiRoute() + "/comments", FixedGHPullRequestReviewComment.class).wrapUp(this);
  }
